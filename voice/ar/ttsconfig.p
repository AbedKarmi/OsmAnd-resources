...
string('route_calculate.ogg', 'تم إعادة حِساب المسار').
...
string('right_sl.ogg', 'انعطِفْ قليلا الى اليمين').
string('left_keep.ogg', 'إلزم اليسار').
string('right_keep.ogg', 'إلزم اليمين').
string('left_bear.ogg', 'واظب على اليسار').    % in English the same as left_keep, may be different in other languages
string('right_bear.ogg', 'واظب على اليمين').   % in English the same as right_keep, may be different in other languages

% U-TURNS
string('make_uturn.ogg', 'إستَدِر إلى الوراء').
string('make_uturn_wp.ogg', 'عندما تتمكن، إستَدِر إلى الوراء').
...
% STRAIGHT/FOLLOW
string('go_ahead.ogg', 'إتجِهْ مُباشَرَةً الى الأَمام').
string('follow.ogg', ' إستمِرْ لـ').  % 'Follow the course of the road for' perceived as too chatty by many users
...
string('reached_intermediate.ogg', ' لقد وصلتَ الى وِجْهَتِك الوسطى').
...
string('and_arrive_poi.ogg', ' واعبُر نقطةالاهتمام').
string('reached_poi.ogg', ' انت تعبُر نقطة الاهتمام').
...
string('off_route.ogg', ' لقد كنت خارج المسار ل').
